...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-siteWorkers">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($workers as $key => $worker)
                        <tr data-entry-id="{{ $worker->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $worker->active ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-siteWorkers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
