...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.bonu.title_singular') }}
        </div>
            ...
            <form method="POST" action="{{ route("admin.bonus.update", [$bonu->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('uuid') ? 'is-invalid' : '' }}" type="text" name="uuid"
                           id="uuid" value="{{ old('uuid', $bonu->uuid) }}" required>
                    @if($errors->has('uuid'))
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="active" id="active"
                               value="1" {{ $bonu->active || old('active', 0) === 1 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name"
                           id="name" value="{{ old('name', $bonu->name) }}">
                    @if($errors->has('name'))
                        <div class="invalid-feedback">
                            {{ $errors->first('name') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" name="category"
                        ...
                        @foreach(App\Models\Bonus::CATEGORY_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('category', $bonu->category) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('priority') ? 'is-invalid' : '' }}" type="number"
                           name="priority" id="priority" value="{{ old('priority', $bonu->priority) }}" step="1"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ordering') ? 'is-invalid' : '' }}" type="number"
                           name="ordering" id="ordering" value="{{ old('ordering', $bonu->ordering) }}" step="1"
                           required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}"
                              name="description"
                              id="description">{!! old('description', $bonu->description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('delay') ? 'is-invalid' : '' }}" type="number"
                           name="delay" id="delay" value="{{ old('delay', $bonu->delay) }}" step="1">
                    @if($errors->has('delay'))
                        <div class="invalid-feedback">
                            {{ $errors->first('delay') }}
                        </div>
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('auto_assign') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="auto_assign" id="auto_assign"
                               value="1" {{ $bonu->auto_assign || old('auto_assign', 0) === 1 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('start_at') ? 'is-invalid' : '' }}" type="text"
                           name="start_at" id="start_at" value="{{ old('start_at', $bonu->start_at) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('end_at') ? 'is-invalid' : '' }}" type="text"
                           name="end_at" id="end_at" value="{{ old('end_at', $bonu->end_at) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('timezone') ? 'is-invalid' : '' }}" type="text"
                           name="timezone" id="timezone" value="{{ old('timezone', $bonu->timezone) }}" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('site') ? 'is-invalid' : '' }}" name="site_id"
                        ...
                        @foreach($sites as $id => $entry)
                            <option value="{{ $id }}" {{ (old('site_id') ? old('site_id') : $bonu->site->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('site'))
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('function_name') ? 'is-invalid' : '' }}" type="text"
                           name="function_name" id="function_name"
                           value="{{ old('function_name', $bonu->function_name) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sourceid') ? 'is-invalid' : '' }}" type="text"
                           name="sourceid" id="sourceid" value="{{ old('sourceid', $bonu->sourceid) }}">
