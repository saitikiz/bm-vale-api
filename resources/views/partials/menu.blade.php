<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('bonus_request_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.bonus-requests.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/bonus-requests") || request()->is("admin/bonus-requests/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
